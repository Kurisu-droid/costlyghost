...
export class PricingDashboardService {
    ...
    marginProfileLines;
    snapshots;
    constructor(products, prices, marginProfiles, marginProfileLines, snapshots) {
        this.products = products;
        this.prices = prices;
        this.marginProfiles = marginProfiles;
        this.marginProfileLines = marginProfileLines;
        this.snapshots = snapshots;
    }
    buildRows(overheadResolver, filters = {}) {
        ...
        const filteredProducts = activeProducts.filter((product) => {
            if (filters.type && String(product.type) !== filters.type)
                return false;
