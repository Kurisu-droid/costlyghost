...
const def = (id, code, sectionEnum, category, nameEl, nameEn, importableFromInvoice = true) => ({
...
export const expenseValueVersions = expenseDefinitions.map((definition, index) => ({
    id: `ev-${index + 1}`,
    expenseDefinitionId: definition.id,
    periodYear: 2026,
    periodMonth: null,
    amount: (definition.sectionEnum === 'RAW_MATERIAL_PRICES' ? 42000 :
        definition.sectionEnum === 'PRODUCTION_PARAMETERS' ? 12000 :
            definition.sectionEnum === 'PRODUCTION_LABOUR' ? 485000 :
                definition.sectionEnum === 'OFFICE_ADMIN' ? 86000 :
                    definition.sectionEnum === 'FACTORY_GENERAL_OVERHEAD' ? 64000 : 37000) + index * 850,
    currency: 'EUR',
...
export const productionParameterVersions = [
    {
...
export const expenseImportMatches = [
    {
        id: 'eim-1',
...
export const expenseAllocationRules = [
...
export const hourlyCostSnapshots = [];
export const finalizedExpenseYears = new Set();
export const quotes = [
    {
        id: 'quote-doc-1',
...
export const quoteLinePriceSnapshots = [
    {
        id: 'qlps-1',
        quoteLineId: 'ql-1',
        tier1Price: 2.04,
...
export const quoteStatusHistory = [
...
export const getActiveOverheadSet = () => overheadSets[0];
export const getOverheadForProduct = (product) => overheadSets.find((set) => set.id === product.overheadSetOverrideId) ?? getActiveOverheadSet();
...
export const rowMatchCandidates = [
...
export const proposedPriceChanges = [
...
export const proposedExpenseUpdates = [
