...
import { expenseAllocationRules, expenseDefinitions, expenseImportMatches, expenseValueVersions, finalizedExpenseYears, costSnapshots, getOverheadForProduct, hourlyCostSnapshots, importBatches, importMappingTemplates, importRows, marginProfileLines, marginProfiles, marginRules, priceSnapshots, prices, productionParameterVersions, draftPriceLists, products, proposedExpenseUpdates, proposedPriceChanges, customers, quoteRecords, quoteLines, quoteLinePriceSnapshots, quoteStatusHistory, rowMatchCandidates, suppliers } from '../services/dataStore.js';
...
const expenseService = new ExpenseService(expenseDefinitions, expenseValueVersions, productionParameterVersions, expenseImportMatches, expenseAllocationRules, hourlyCostSnapshots, finalizedExpenseYears);
const quoteService = new QuoteService(products, prices, getOverheadForProduct, marginProfileLines, customers, quoteRecords, quoteLines, quoteLinePriceSnapshots, quoteStatusHistory);
...
const importService = new ImportService(importBatches, importRows, rowMatchCandidates, proposedPriceChanges, proposedExpenseUpdates, importMappingTemplates, expenseValueVersions);
