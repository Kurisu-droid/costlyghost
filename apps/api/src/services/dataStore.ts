...
export const customers: Customer[] = [
  {
    ...
    code: 'CUST-0001',
    name: 'Σκλαβενίτης ΑΕ',
    vatNumber: 'EL094010203',
    email: 'procurement@sklavenitis.gr',
    phone: '+30-210-1234567',
    address: 'Λεωφ. Κηφισού 136',
    city: 'Αθήνα',
    country: 'GR',
    notes: 'Κεντρικός πελάτης λιανικής',
    active: true,
    createdAt: now
  },
  {
    ...
    email: 'buyers@masoutis.gr',
    phone: '+30-2310-445566',
    address: '14ο χλμ Θεσσαλονίκης-Νέας Μηχανιώνας',
    city: 'Θεσσαλονίκη',
    country: 'GR',
    notes: 'Πελάτης Βόρειας Ελλάδας',
    active: true,
    createdAt: now
  }
];
...
export const customerContacts: CustomerContact[] = [
  { id: 'cc-1', customerId: 'cust-1', name: 'Νίκος Παπαδόπουλος', email: 'n.papadopoulos@sklavenitis.gr', phone: '+30-6977000001', role: 'Procurement Manager' },
  { id: 'cc-2', customerId: 'cust-2', name: 'Μαρία Ιωάννου', email: 'm.ioannou@masoutis.gr', phone: '+30-6977000002', role: 'Category Buyer' }
];
...
export const quoteLines: QuoteLineRecord[] = [
  {
    ...
    quoteId: 'Q-00001',
    productId: 'prod-1',
    skuSnapshot: 'SKU-FOIL-001',
    descriptionSnapshot: 'Αλουμινόχαρτο 30m x 29cm',
    subcategorySnapshot: 'foil-household',
    quantity: 480,
    unitPrice: 1.8,
    discountPercent: 5,
    lineTotal: 820.8,
    priceSnapshotId: 'qlps-1',
    costSnapshotId: undefined
  }
];
...
export const quoteStatusHistory: QuoteStatusHistoryRecord[] = [
  { id: 'qsh-1', quoteId: 'Q-00001', status: 'DRAFT', changedAt: now, changedBy: 'demo-seed' },
  { id: 'qsh-2', quoteId: 'Q-00001', status: 'FINALIZED', changedAt: now, changedBy: 'demo-seed' }
];

export const quotePdfs: QuotePdfRecord[] = [
  { id: 'qpdf-1', quoteId: 'Q-00001', filePath: '/tmp/quotes/Q-00001.pdf', createdAt: now }
];
